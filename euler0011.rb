...
# Решается прямым перебором, но более общая задача,
# когда высота и ширина таблицы неизвестны. 
...
width = matrix[0].size # Ширина таблицы
height = matrix.size # Высота таблицы
